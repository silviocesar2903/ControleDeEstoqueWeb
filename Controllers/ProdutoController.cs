...
namespace ControleDeEstoqueWeb.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public ProdutoController(ControleDeEstoqueWebContext context)
        {
        ...
        public async Task<IActionResult> Excluir(int? id)
        {
            if(!id.HasValue)
            {
                TempData["mensagem"] = MensagemModel.Serializar("Produto não informada!!", TipoMensagem.Erro);
                return RedirectToAction(nameof(Index));
            }
            var produto = await _context.Produtos.FindAsync(id);
            if(produto == null)
        ...
        public async Task<IActionResult> Excluir(int id)
        {
            ...
            if(produto != null)
            {
                ...
                {
                    TempData["mensagem"] = MensagemModel.Serializar("Não foi possivel exlcuir o produto!!", TipoMensagem.Erro);
                }
            }
            else
            {
